...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonChangeId = findViewById(R.id.id_change_btn);
        ...
        textViewNameChange.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        textViewChangeID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
